...
{
  new (message_memory) tiago_gazebo::msg::Order(_init);
}

void Order_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tiago_gazebo::msg::Order *>(message_memory);
  typed_message->~Order();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Order_message_member_array[2] = {
  {
    ...
    offsetof(tiago_gazebo::msg::Order, destination_table_number),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tiago_gazebo::msg::Order, item),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Order_message_members = {
  "tiago_gazebo::msg",  // message namespace
  "Order",  // message name
  2,  // number of fields
  sizeof(tiago_gazebo::msg::Order),
...
{
  return &::tiago_gazebo::msg::rosidl_typesupport_introspection_cpp::Order_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tiago_gazebo, msg, Order)() {
  return &::tiago_gazebo::msg::rosidl_typesupport_introspection_cpp::Order_message_type_support_handle;
}
